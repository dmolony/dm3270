...
public abstract class Command extends AbstractTN3270Command
{
      ...
      ScreenHandler screenHandler)
  {
    switch (buffer[offset])
    {
      ...
      case Command.WRITE_01:
        return new WriteCommand (buffer, offset, length, screenHandler, false);
      ...
      case Command.ERASE_WRITE_ALTERNATE_0D:
        return new WriteCommand (buffer, offset, length, screenHandler, true);
      ...
      case Command.ERASE_ALL_UNPROTECTED_0F:
        return new EraseAllUnprotectedCommand (screenHandler, buffer, offset, length);
      ...
      case Command.READ_MODIFIED_ALL_0E:
        ...
        return new ReadCommand (screenHandler, buffer, offset, length);
  ...
  public static Command getReply (ScreenHandler screenHandler, byte[] buffer, int offset,
      int length)
  {
    switch (buffer[offset])
    {
      ...
      default:
        return new AIDCommand (screenHandler, buffer, offset, length);
    }
  }

  public Command (ScreenHandler screenHandler)
  {
    super (screenHandler);
  }
