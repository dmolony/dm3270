### Functions
Four functions available in Debug Mode - Spy, Replay, Terminal and Test. This is the Debug Mode dialog box.  
...
![Mainframe screen](server.png?raw=true "mainframe screen")
#### Terminal Function
